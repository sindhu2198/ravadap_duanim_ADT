  ...
  return (
    <div className="delete-employee">
      ...
      <div className="card-update">
        ...
        <input id="projects_2023" name="projects_2023" type="text" value={user.projects_2023} onChange={handleChange} placeholder="No projects in 2023" disabled />

        <br />
        < label htmlFor="projects_2022">Projects in 2022 (if any): </label>
        <input id="projects_2022" name="projects_2022" type="text" value={user.projects_2022} onChange={handleChange} placeholder="No projects in 2022" disabled />
        <br />

        <br />
        <label htmlFor="projects_2021">Projects in 2021 (if any): </label>
        <input id="projects_2021" name="projects_2021" type="text" value={user.projects_2021} onChange={handleChange} placeholder="No projects in 2021" disabled />
        <br />
